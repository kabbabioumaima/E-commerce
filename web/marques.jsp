...
<html>
    ...
    <link rel="stylesheet" href="styles.css" />
        ...
        <style>
            ...
            * {
            ...
            .marque_section .marque_tab h1 {
                color: #000;
            }

            .marque_section .marque_tab .t_btn_tablinks {
            ...
            .marque_section .marque_tab .t_btn_tablinks:hover {
                background-color:#B0C4DE;
            }

            .marque_section .marque_tab .t_btn_tablinks.active_t {
                background-color: #B0C4DE;
            }

            .marque_section .marque_tabcontent {
                display: none;
                padding: 6px 12px;
                border-top: none;
            }

            .marque_section #see_marque {
                margin: 20px 0px;
            }

            .marque_section #see_marque .marque_search .search_input {
                padding: 10px 5px;
                width: 250px;
                margin: 10px 0px;
                border: 1px solid #5987B2;
            ...
            .marque_section #see_marque .marque_search .search_input:focus {
                outline: none;
                -webkit-box-shadow: none;
                box-shadow: none;
            }

            .marque_section #see_marque table {
            ...
            .marque_section #see_marque tr:nth-child(even) {
                background-color: #e6e3e3;
                color: #000;
            }

            .marque_section #add_marque form {
                background-color: #fff;
                border: 1px solid #5987B2;
                border-radius: 15px;
            ...
            .marque_section #add_marque form h2 {
            ...
            .marque_section #add_marque form .first_last_name {
                display: -webkit-box;
                display: -ms-flexbox;
                display: flex;
                -webkit-box-pack: justify;
            ...
            .marque_section #add_marque form .first_last_name .f_left {
                width: 49%;
            }

            .marque_section #add_marque form .first_last_name .l_right {
                width: 50%;
            }

            .marque_section #add_marque form .t_city {
                display: -webkit-box;
                display: -ms-flexbox;
                display: flex;
                -webkit-box-pack: justify;
            ...
            .marque_section #add_marque form .t_city .t_city_left {
                width: 49%;
            }

            .marque_section #add_marque form .t_city .t_city_right {
                width: 49%;
            }

            .marque_section #add_marque form input {
                width: 100%;
                padding: 10px;
                margin-bottom: 20px;
                border: 1px solid #5987B2;
            ...
            .marque_section #add_marque form input:focus {
                border: 1px solid #5987B2;
            }

            .marque_section #add_marque form label {
                font-size: 20px;
                line-height: 40px;
                font-weight: 500;
                color: #000;
            ...
            .marque_section #add_marque form select {
                padding: 10px;
                margin-bottom: 20px;
                cursor: pointer;
                border: 1px solid #5987B2;
            ...
            .marque_section #add_marque form #sub_marque_btn {
                padding: 10px 50px;
                outline: none;
                border: 1px solid #5987B2;
                cursor: pointer;
            ...
            .marque_section #add_marque form #sub_marque_btn:hover {
                background-color: #B0C4DE;
                border: 1px solid #5987B2;
            }
            ...
            .modal .modal_body form #sub_marque_btn {
                padding: 10px 50px;
                outline: none;
                border: 1px solid #5987B2;
                cursor: pointer;
            ...
            .modal .modal_body form #sub_marque_btn:hover {
                background-color: #CCE6FF;
                border: 1px solid #5987B2;
            }
                            ...
                            <div class="col">
                                <div class="marque_section">
                                    <div class="marque_tab">
                                        ...
                                        <div class="marque_tab_inner">
                                            <button class="t_btn_tablinks" onclick="marqueFunc(event, 'see_marque')"id="t_defaultOpen" >Liste
                                                <i class="fas fa-info-circle"></i>
                                            </button>
                                            <button class="t_btn_tablinks" onclick="marqueFunc(event, 'add_marque')">Add
                                                <i class="fas fa-plus-circle"></i>
                                            </button>

                                        </div>
                                    </div>
                                    <!-- view marque section start  ======================================-->
                                    <div id="see_marque" class="marque_tabcontent">
                                        <div class="marque_search">
                                            <input type="text" class="search_input" placeholder="Chercher marque...">
                                        </div>
                                        <table>
                                            <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="./DeleteMarque?id=<%=e.getId()%> " onclick="return confirm('remove item from marques?')">Supprimer</a></td>
                                                </tr>
                                    ...
                                    <div id="add_marque" class="marque_tabcontent">
                                        <form method="Post" action="MarqueController">
                                            ...
                                            <input type="submit" id="sub_marque_btn"></input>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="marque.js" type="text/javascript"></script>
</html>