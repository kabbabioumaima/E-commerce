                                ...
                                <div class="categorie_section">
                                    <div class="categorie_tab">
                                        ...
                                        <div class="categorie_tab_inner">
                                            ...
                                            <button class="t_btn_tablinks" onclick="categorieFunc(event, 'add_categorie')">Add
                                    ...
                                    <div id="see_categorie" class="categorie_tabcontent">
                                        <div class="categorie_search">
                                            <input type="text" class="search_input" placeholder="Chercher categorie...">
                                        </div>
                                        <table>
                                            <tr>
                                                <th width="100px">Id</th>
                                                <th width="300px">Nom</th>
                                                <th width="300px">Super Categorie</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="./DeleteCategorie?id=<%=e.getId()%> " onclick="return confirm('remove item from categories?')">Supprimer</a></td>
                                                </tr>
                                    ...
                                    <div id="add_categorie" class="categorie_tabcontent">
                                        <form method="Post" action="CategorieController">
                                            ...
                                            <input type="submit" id="sub_categorie_btn"></input>
                                        </form>
                                    </div>
                                </div>
                            </div>
