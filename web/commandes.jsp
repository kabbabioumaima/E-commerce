    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .commande_section #successMessage {
                position: fixed;
                top: 20px;
                margin-left: 10%;
                display: none;
            ...
            .commande_section .commande_tab h1 {
                color: #000;
            }

            .commande_section .commande_tab .t_btn_tablinks {
            ...
            .commande_section .commande_tab .t_btn_tablinks:hover {
                background-color: #B0C4DE;
            }

            .commande_section .commande_tab .t_btn_tablinks.active_t {
                background-color: #B0C4DE;
            }

            .commande_section .commande_tabcontent {
                display: none;
                padding: 6px 12px;
                border-top: none;
            }

            .commande_section #see_commande {
                margin: 20px 0px;
            }

            .commande_section #see_commande .commande_search .search_input {
                padding: 10px 5px;
                width: 280px;
                margin: 10px 0px;
                border: 1px solid #5987B2;
            ...
            .commande_section #see_commande .commande_search .search_input:focus {
                outline: none;
                -webkit-box-shadow: none;
                box-shadow: none;
            }

            .commande_section #see_commande table {
            ...
            .commande_section #see_commande th {
            ...
            .commande_section #see_commande td {
                border: 1px solid #dddddd;
                text-align: left;
                padding: 8px;
                color: #000;
            ...
            .commande_section #see_commande tr:nth-child(even) {
                background-color: #e6e3e3;
                color: #000;
            }

            .commande_section #add_commande form {
                background-color: #fff;
                border: 1px solid #5987B2;
                border-radius: 15px;
            ...
            .commande_section #add_commande form h2 {
            ...
            .commande_section #add_commande form .first_last_name {
                display: -webkit-box;
                display: -ms-flexbox;
                display: flex;
                -webkit-box-pack: justify;
            ...
            .commande_section #add_commande form .first_last_name .f_left {
                width: 49%;
            }

            .commande_section #add_commande form .first_last_name .l_right {
                width: 49%;
            }

            .commande_section #add_commande form .t_city {
                display: -webkit-box;
                display: -ms-flexbox;
                display: flex;
                -webkit-box-pack: justify;
            ...
            .commande_section #add_commande form .t_city .t_city_left {
                width: 49%;
            }

            .commande_section #add_commande form .t_city .t_city_right {
                width: 49%;
            }

            .commande_section #add_commande form input {
                width: 100%;
                padding: 10px;
                margin-bottom: 20px;
                border: 1px solid #5987B2;
            ...
            .commande_section #add_commande form input:focus {
                border: 1px solid yellow;
            }

            .commande_section #add_commande form label {
                font-size: 20px;
                line-height: 40px;
                font-weight: 500;
                color: #000;
            ...
            .commande_section #add_commande form select {
                padding: 10px;
                margin-bottom: 20px;
                cursor: pointer;
                border: 1px solid #5987B2;
            ...
            .commande_section #add_commande form #sub_commande_btn {
                padding: 10px 50px;
                outline: none;
                border: 1px solid #5987B2;
                cursor: pointer;
            ...
            .commande_section #add_commande form #sub_commande_btn:hover {
                background-color: #B0C4DE;
                border: 1px solid #5987B2;
            }
            ...
            .modal .modal_body form #sub_commande_btn {
                padding: 10px 50px;
                outline: none;
                border: 1px solid #5987B2;
                cursor: pointer;
            ...
            .modal .modal_body form #sub_commande_btn:hover {
                background-color: #CCE6FF;
                border: 1px solid #5987B2;
            }
        ...
        <div class="d-flex" id="wrapper">
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="home.jsp" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i
            ...
            <div class="bg-info" id="page-content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light   bg-transparent py-4 px-4">
                    <div class="container-fluid px-4">
                        <div class="row my-5">
                            <div class="col">
                                <div class="commande_section">
                                    <div class="commande_tab">
                                        ...
                                        <div class="commande_tab_inner">
                                            <button class="t_btn_tablinks" onclick="commandeFunc(event, 'see_commande')"id="t_defaultOpen" >Liste
                                                <i class="fas fa-info-circle"></i>
                                            </button>


                                        </div>                      </div>
                                    <div id="see_commande" class="commande_tabcontent">
                                        <form action="Filtre.jsp" method="">
                                            <!-- view commande section start  ======================================-->


                                            <div class="commande_search">
                                                <select name="etat">
                                        ...
                                        <table>
                                            ...
                                            <form method="POST" action="UpdateEtat">
                                                <tr>
                                                    ...
                                                    <td style="display: none;"><input type="text" name="id" value="<%= e.getId()%>"></td>

                                                    <td><input style="color: black; background: #B0C4DE; padding: 1px 20px;margin: 0 10px;" type="submit" value="Modifier" name="Modifier" /></td>
                                                    <td><a href="detailsComm.jsp?idc=<%=e.getId()%>" onclick="" style="color: black; background: #B0C4DE; padding: 1px 30px;margin: 0 20px;" >Détails</a></td>
