function marqueFunc(evt, marqueName) {
  var i, t_tabcontent, t_tablinks;
  t_tabcontent = document.getElementsByClassName("marque_tabcontent");
  ...
  document.getElementById(marqueName).style.display = "block";
